...
def df_ops_ru() -> pd.DataFrame:
    ...
    rows = [
        ...
        {
            "Дата операции": base + timedelta(days=1),
            "Категория": "Зарплата",
        ...
        {
            "Дата операции": base + timedelta(days=2),
            "Категория": "Аптеки",
            "Сумма операции": -2000.00,
            "Бонусы (включая кэшбэк)": None,
            "Кэшбэк": 100,
        },
        # Наличные (исключаем из top при расчёте расходов в utils.calc_expenses)
        {
            "Дата операции": base + timedelta(days=3),
            "Категория": "Наличные",
        ...
        # Переводы (исключаем)
        {
            "Дата операции": base + timedelta(days=4),
            "Категория": "Переводы",
        ...
        {
            "Дата операции": base + timedelta(days=5),
            "Категория": "Супермаркеты",
            "Сумма операции": -700.00,
            "Бонусы (включая кэшбэк)": 35,
            "Кэшбэк": None,
        },
    ]
